...
- L’affichage initial de `MatchSetup` démarre immédiatement une expérience active et demande un verrou d’écran natif, sans clic ni démarrage préalable de la reconnaissance vocale.
- Le verrou reste identique pendant la transition entre configuration et match.
...
- Le diagnostic expose l’état demandé, acquis ou libéré, le nombre d’acquisitions et de libérations, ainsi que l’origine et l’horodatage de la dernière libération.
...
1. Un verrou `screen` est demandé dès que l’expérience entre en configuration.
2. Le verrou reste référencé tant que la session est active.
3. Le verrou est explicitement libéré à la fin de la session, lors d’une annulation, au retour à l’accueil et au démontage.
...
9. Le verrou reste actif pendant les annonces, les relances techniques, un redémarrage de configuration et la transition vers le match.
10. Le diagnostic permet de distinguer une libération système d’une libération liée à la fin de l’expérience ou au démontage.
